...
@Autonomous(name = "RedAudienceWebcam", group = "Iterative Opmode")
//@Disabled
public class AutoRedAudienceWebcam extends OpMode {
...
//        }
    ...
    public void loop() {
        switch (task) {
            ...
            case "strafe out of wall": //oogaboooga ya'll
                encoderStrafe(0.8, -7, 7);
...
//                break;
            ...
            case "SPEEDY TO PARK":
                if (checkEncoderDone()) {
                    ...
                    task = "strafe fully into park";
                }
                break;

            case "strafe fully into park":
                if (checkEncoderDone()) {
                    encoderComplete();
                    if (BarcodePosition == 1) {
